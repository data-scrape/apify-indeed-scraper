...
> Apify-style Indeed scraper alternative - free & open source

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/apify-indeed-scraper?style=flat-square)](https://github.com/data-scrape/apify-indeed-scraper)
[![Forks](https://img.shields.io/github/forks/data-scrape/apify-indeed-scraper?style=flat-square)](https://github.com/data-scrape/apify-indeed-scraper/forks)
...
**Apify Indeed Scraper** is a free, open-source Python scraper for **Indeed (Apify Alternative)**. Extract structured data from indeed (apify alternative) with full pagination support, proxy rotation, and multiple export formats.

apify indeed scraper, indeed scraper apify, apify alternative indeed
...
```bash
git clone https://github.com/data-scrape/apify-indeed-scraper.git
...
```bash
python scraper.py "Product Manager in New York"
```
...
`job_id` | `title` | `company` | `company_url` | `location` | `salary` | `job_type` | `posted_date` | `description` | `apply_url` | `is_sponsored`

## 💡 Use Cases

- Migrating from Apify to free alternative
- Budget-friendly job data collection
- Custom Indeed scraping pipeline
